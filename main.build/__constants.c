...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    Nuitka_SysSetObject(
        ...
        global_constants[98]
#else
        getStandaloneSysExecutablePath(global_constants[98])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 2, Nuitka_PyInt_FromLong(9));
