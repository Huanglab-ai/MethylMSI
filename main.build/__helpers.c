...
PyObject *CALL_FUNCTION_WITH_ARGS14(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 14, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 14);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 14);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS15(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 15, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 15);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 15);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS16(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 16, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 16);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 16);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS18(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 18, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 18);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 18);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS21(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 21 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 21);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 21);
            ...
            if (function->m_args_simple && 21 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 21);
            }
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 21, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 21);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 21);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 21);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS21(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS23(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 23 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 23);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 23);
            ...
            if (function->m_args_simple && 23 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 23);
            }
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 23, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 23);
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 23, NULL);
#endif
        CHECK_OBJECT_X(result);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 23);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 23);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS23(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS24(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 24, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 24);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 24);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS29(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 29 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 29);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 29);
            ...
            if (function->m_args_simple && 29 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 29);
            }
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 29, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 29);
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 29, NULL);
#endif
        CHECK_OBJECT_X(result);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 29);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 29);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS29(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS32(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 32 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 32);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 32);
            ...
            if (function->m_args_simple && 32 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 32);
            }
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 32, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 32);
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 32, NULL);
#endif
        CHECK_OBJECT_X(result);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 32);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 32);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS32(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS11_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
     CHECK_OBJECTS(args, 11); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(tstate, function, args, 11, kw_values, kw_names);
...
PyObject *CALL_FUNCTION_WITH_ARGS13_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
     CHECK_OBJECTS(args, 13); 
    CHECK_OBJECT(kw_names);
    assert(PyTuple_CheckExact(kw_names));
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(tstate, function, args, 13, kw_values, kw_names);
...
PyObject *CALL_FUNCTION_WITH_ARGS14_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
     CHECK_OBJECTS(args, 14); 
    CHECK_OBJECT(kw_names);
    assert(PyTuple_CheckExact(kw_names));
    CHECK_OBJECT(called);
...
PyObject *CALL_FUNCTION_WITH_ARGS15_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
     CHECK_OBJECTS(args, 15); 
    CHECK_OBJECT(kw_names);
    assert(PyTuple_CheckExact(kw_names));
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(tstate, function, args, 15, kw_values, kw_names);
...
PyObject *CALL_METHOD_WITH_ARGS14(PyThreadState *tstate, PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && Nuitka_Descr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS14(tstate, called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS14(tstate, descr, args)
;
            Py_DECREF(descr);
            return result;
        }
        ...
        // so we need not release it in this branch.
        if (called_object != NULL) {
            return CALL_FUNCTION_WITH_ARGS14(tstate, called_object, args)
;
        }
        ...
        if (called_object != NULL) {
            ...
            if (descr_get == Nuitka_Function_Type.tp_descr_get) {
                ...
                PyObject *result = CALL_FUNCTION_WITH_ARGS14(tstate, method, args)
;
                Py_DECREF(method);
                return result;
            } else {
...
PyObject *CALL_METHOD_WITH_ARGS20(PyThreadState *tstate, PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && Nuitka_Descr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS20(tstate, called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS20(tstate, descr, args)
;
            Py_DECREF(descr);
            return result;
        }
        ...
        // so we need not release it in this branch.
        if (called_object != NULL) {
            return CALL_FUNCTION_WITH_ARGS20(tstate, called_object, args)
;
        }
        ...
        if (called_object != NULL) {
            ...
            if (descr_get == Nuitka_Function_Type.tp_descr_get) {
                ...
                PyObject *result = CALL_FUNCTION_WITH_ARGS20(tstate, method, args)
;
                Py_DECREF(method);
                return result;
            } else {
