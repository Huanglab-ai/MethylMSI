...
static PyObject *module_var_accessor___main___$$_create_gui(PyThreadState *tstate) {
#if 0
    PyObject *result;
...
static PyObject *module_var_accessor___main___$$_root(PyThreadState *tstate) {
#if 0
    PyObject *result;
...
static void createModuleCodeObjects(void) {
    ...
    code_objects_41dbc5a7e9d32fdcfc0e44c136d2c207 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[30], mod_consts[30], NULL, NULL, 0, 0, 0);
...
NUITKA_LOCAL_MODULE PyObject *impl___main__$$$helper_function_get_callable_name_desc(PyThreadState *tstate, PyObject **python_pars) {
    ...
    branch_no_1:;
    {
        ...
        tmp_add_expr_left_2 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_2, mod_consts[5]);
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$helper_function_complex_call_helper_pos_star_list_star_dict(PyThreadState *tstate, PyObject **python_pars) {
...

    {
        ...
        PyObject *tmp_cmp_expr_left_3;
        PyObject *tmp_cmp_expr_right_3;
        tmp_cmp_expr_left_3 = exception_keeper_name_1.exception_type;
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$helper_function_complex_call_helper_keywords_star_list_star_dict(PyThreadState *tstate, PyObject **python_pars) {
    ...
    branch_yes_6:;
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tstate, tmp_expression_value_6, mod_consts[2]);
        if (tmp_res == -1) {
            assert(HAS_ERROR_OCCURRED(tstate));
        ...
        tmp_res = HAS_ATTR_BOOL2(tstate, tmp_expression_value_7, mod_consts[3]);
        if (tmp_res == -1) {
            assert(HAS_ERROR_OCCURRED(tstate));
    ...
    branch_no_7:;
    {
        ...
        tmp_mod_expr_right_4 = MAKE_TUPLE_EMPTY(tstate, 2);
        {
            ...
            tmp_tuple_element_4 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_8, mod_consts[5]);
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$helper_function_complex_call_helper_dict_unpacking_checks(PyThreadState *tstate, PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_direct_call_arg1_1};
            tmp_mod_expr_right_1 = impl___main__$$$helper_function_get_callable_name_desc(tstate, dir_call_args);
        }
...
// Set the "__spec__" value
    ...
    // Tried code:
    {
        ...
        PyObject *tmp_iter_arg_1;
        PyObject *tmp_called_value_1;
        tmp_called_value_1 = module_var_accessor___main___$$_create_gui(tstate);
    ...
    tmp_tuple_unpack_1__source_iter = NULL;
    {
        ...
        UPDATE_STRING_DICT0(moduledict___main__, (Nuitka_StringObject *)mod_consts[26], tmp_assign_source_9);
    }
    Py_XDECREF(tmp_tuple_unpack_1__element_1);
    tmp_tuple_unpack_1__element_1 = NULL;

    {
        ...
        UPDATE_STRING_DICT0(moduledict___main__, (Nuitka_StringObject *)mod_consts[27], tmp_assign_source_10);
    }
    Py_XDECREF(tmp_tuple_unpack_1__element_2);
    tmp_tuple_unpack_1__element_2 = NULL;

    {
        ...
        tmp_called_instance_1 = module_var_accessor___main___$$_root(tstate);
